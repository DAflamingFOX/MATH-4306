...
\begin{enumerate}[label=\textbf{\arabic*}.]
      ...
      \item Identify each of the following as being even, odd, or neither.
            \begin{enumerate}[label=\textbf{\alph*}.]
                  ...
                  %
                  \item $f(x)=x$
                        \subfile{src/HW01/HW01P3a.tex}
                        %
                        % Problem 3-b
                        %
                  \item $f(x)=\left|x\right|$
                        \subfile{src/HW01/HW01P3b.tex}
                        %
                        % Problem 3-c
                        %
                  \item $f(x)=\left|\cos(x)\right|$
                        \subfile{src/HW01/HW01P3c.tex}
                        %
                        % Problem 3-d
                        %
                  \item $f(x)=\arcsin(x)$
                        \subfile{src/HW01/HW01P3d.tex}
                        %
                        % Problem 3-e
                        %
                  \item $f(x)=x\cos(x)$
                        \subfile{src/HW01/HW01P3e.tex}
                        %
                        % Problem 3-f
                        %
                  \item $f(x)=x+\cos(x+1)$
                        \subfile{src/HW01/HW01P3f.tex}
            \end{enumerate}
            %
            % Problem 4
            %
